...
//          for Part 3 -- changed  http to https on line below
...
//  Blocked Implicit Intent above  and added explicit intent because there is no need to go outside to get product information available within
